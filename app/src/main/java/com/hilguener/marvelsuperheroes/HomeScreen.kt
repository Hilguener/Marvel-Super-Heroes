...
import com.hilguener.marvelsuperheroes.ui.activity.CharactersActivity
...
class HomeScreen : AppCompatActivity(), BaseView {
    ...
    private fun setupSeriesRecyclerView() {
        ...
        seriesRecyclerView.layoutManager =
            GridLayoutManager(this@HomeScreen,2, RecyclerView.HORIZONTAL, false)
    ...
    private fun setupRecyclerView() {
        ...
        recyclerView.layoutManager =
            LinearLayoutManager(this@HomeScreen, RecyclerView.HORIZONTAL, false)
    }
