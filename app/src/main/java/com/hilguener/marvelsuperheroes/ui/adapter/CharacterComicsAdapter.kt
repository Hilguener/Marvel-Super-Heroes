...
import com.hilguener.marvelsuperheroes.databinding.CharacterComicsItemBinding
import com.hilguener.superheroesapp.model.comics.Comic

class CharacterComicsAdapter(private var listener: OnItemClickListener) :
    PagingDataAdapter<Comic, CharacterComicsAdapter.ComicsViewHolder>(
        ComicComparator()
    ) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ComicsViewHolder {
        val binding =
            CharacterComicsItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    inner class ComicsViewHolder(private val binding: CharacterComicsItemBinding) :
